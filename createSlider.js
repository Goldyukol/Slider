function Slider() {
    ...
    this.leftImg = null; // document.querySelector('.left-img'),
    this.rightImg = null; // document.querySelector('.right-img'),
    this.slideImg = null; // document.querySelector('.slide-img'),
    ...
    this.onShowLeftImg = function (event) {
        this.currentIndex--;
        this.slideImg.src = this.imageArray[this.currentIndex];
    ...
    this.onShowRightImg = function (event) {
        this.currentIndex++;
        this.slideImg.src = this.imageArray[this.currentIndex];
